const Spinner = () => {
  return (
    <div className="space-x-2">
      <div
        className="inline-block h-16 w-16 animate-[spin_0.5s_linear_infinite] rounded-full border-8 border-solid border-current border-r-transparent align-[-0.125em] text-primary motion-reduce:animate-[spin_1.5s_linear_infinite]"
        role="status">
        <span
