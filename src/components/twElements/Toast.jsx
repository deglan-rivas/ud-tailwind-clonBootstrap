...
const Toast = () => {
  ...
  return (
    <div>
      ...
      <TEToast open={open} autohide={true} delay={5000} setOpen={setOpen} color="bg-red-400" animation={false}>
        ...
        <div className="break-words rounded-b-lg px-4 py-4 text-neutral-700 dark:text-neutral-200">
          Más info en el node_modules/tw-elements-react/dist/src/lib/components/Toast/Toast.tsx
        </div>
      </TEToast>
      </div>
    </div>
