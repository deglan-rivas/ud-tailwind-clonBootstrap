const Navbar = () => {
  return (
    <section className="bg-white text-sm">
      <nav className="max-w-[1380px] w-full px-8 flex justify-between items-center py-5 bg-gray-100">
