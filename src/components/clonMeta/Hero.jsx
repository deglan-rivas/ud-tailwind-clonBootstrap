      ...
      <div className="max-w-[1230px] mx-auto w-full px-8 py-20">
        <div className="max-w-lg text-white">
          ...
          <div className="flex gap-4">
            <a href="#"
              className="border-2 border-transparent px-7 py-3 bg-blue-600 hover:bg-blue-500 text-white text-xs font-semibold rounded-full inline-flex justify-center items-center"
            >
              Add to bag
            </a>
            <a href="#"
