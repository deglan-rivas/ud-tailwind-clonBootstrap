const FlexBox = () => {
  ...
  return (
    <>
      ...
      <p className="mb-4">notar que se puede el w-full o h-full en  lugar del flex-1. El flex también centra el contenido y pseudoelementos. Usar heroicons, pixabay y picsum para las imágenes xd</p>
      ...
      <div className={`bg-gray-200 w-96 h-[700px] p-8 flex flex-col `}>
        ...
        <div className="bg-white flex-1 flex flex-col">
          <div className="bg-[url('https://cdn.pixabay.com/photo/2017/06/18/03/59/dog-2414477_1280.jpg')] bg-cover bg-center basis-1/3">.
          </div>
          <div className={`basis-2/3 py-2 px-4 overflow-scroll `}>
            <div className="flex mb-3">
              <div className="w-6 flex justify-center items-start">
                  <img src="https://picsum.photos/100/100" alt="test" className="w-4 h-4 rounded-full" />
              </div>
              <div className="flex-1 text-gray-500">
                <p className="text-sm mb-1">@universaluser &bull; <span>hace 1 hora</span></p>
                <p className="text-sm mb-1">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Adipisci quod sint, voluptatibus sit quaerat excepturi, esse cupiditate nesciunt eius illum natus? Omnis sint eveniet sequi, quaerat facilis doloremque ipsam. Iure.</p>
            ...
            <div className="flex mb-3">
              <div className="w-6 flex justify-center items-start">
                  <img src="https://picsum.photos/200/200" alt="test" className="w-4 h-4 rounded-full" />
              </div>
              <div className="flex-1 text-gray-500">
                <p className="text-sm mb-1">@universaluser &bull; <span>hace 1 hora</span></p>
                <p className="text-sm mb-1">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Adipisci quod sint, voluptatibus sit quaerat excepturi, esse cupiditate nesciunt eius illum natus? Omnis sint eveniet sequi, quaerat facilis doloremque ipsam. Iure.</p>
